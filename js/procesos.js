...
function BuscarD(codigo){
    let index=Cod.indexOf(String(codigo));
    if(index>=0){
        var imprimir="";
        imprimir+= '<tr>';
            ...
            imprimir+= '<td>'+
            '<div class="row"> <div class="col" style="padding-right: 0px;"><button onclick="Imprimir('+Id[index]+')" type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">'+
            '<i class="bi bi-pencil-square"></i></button></div>'+
            '<div class="col" style="padding-right: 12px;"><button onclick="Eliminar('+Id[index]+')" type="button" class="btn btn-danger btn-sm" >'+
            '<i class="bi bi-trash"></i></button>'+
            '</td> </div>';
            imprimir+= '</tr>';                              
        ...
        Swal.fire(
            'Dato no existente en nuestra Base de Datos',
            '',
            'error'
        )  
